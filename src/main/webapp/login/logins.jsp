    ...
    <script>
        ...
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/picture/getPicture?time=" + new Date().getTime());
            });
        });
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/picture/getPicture">
                                <input style="width: 243px;height: 50px;border:3px solid #ddd;border-radius: 4px;"
